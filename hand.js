function pair(){
    if(//triple of Aces
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Triple';
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Triple';
    }else if(//Two Pairs Aces and Kings
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Pair';
