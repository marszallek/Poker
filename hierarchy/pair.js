const pair = () => {
    if(//pairs of Aces
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Pair 6';
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Pair 5';
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Pair 4';
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Pair 3';
    }else if(//pairs of 10
        //one with, two. three, four and five
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Pair 2';
    }else if(//pairs of 9
        //one with, two. three, four and five
        ...
        document.getElementById('whatsOnHand').innerHTML = 'Pair 1';
